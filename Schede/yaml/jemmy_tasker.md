...
cyberware:
  neural:
    - name: Collegamento neurale
      ...
      options:
        - name: Connettore d'interfaccia
          hl: 7
          notes: Permette di usare SmartGun e guidare veicoli senza mani
        - name: DeathTrance
          hl: 3
          notes: Permette di simulare morte apparente
        - name: Alveolo
          hl: 7
          notes: Permette l'uso di chip
        - name: Chip abilità avanzato
          hl: 7
          notes: "Fuoco Automatico: +3"
  ...
  cyberarm_dx:
    - name: Cyberbraccio
      ...
      options:
        - name: Cyberdeck
          hl: 3
          notes: Cyberdeck integrato nel braccio
  ...
  cyberoptics_dx:
    - name: Cyberocchio
      ...
      options:
        - name: Virtuality
          hl: 2
          notes: Visore virtuality integrato nella retina
        - name: Mirino
          hl: 3
          notes: "+1 ai Colpi Mirati"
